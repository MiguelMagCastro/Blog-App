        ...
        <div class="flex space-x-3">
            @if($chirp->user)
                <div class="avatar">
                    <div class="size-10 rounded-full">
                        <img
                            src="https://avatars.laravel.cloud/{{ md5(strtolower(trim($chirp->user->email))) }}"
            ...
            @else
                <div class="avatar placeholder">
                    <div class="size-10 rounded-full">
                        <img src="https://avatars.laravel.cloud/d2e5d3c7-066b-4433-9e72-7b69eca0e90f?vibe=stealth"
                             alt="Anonymous User"
                             class="rounded-full" />
                    </div>
                </div>
